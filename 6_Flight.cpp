...
///getgraph(): Time Complexity - O(n^2), Space Complexity - O(n)
///adjlist(): Time Complexity - O(n^2), Space Complexity - O(n^2)
///displaym(): Time Complexity - O(n^2), Space Complexity - O(1)
///displaya(): Time Complexity - O(n^2), Space Complexity - O(n)